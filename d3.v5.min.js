...
!(function(t, n) {
    ...
    function ot(t, n, e, r, i, o, a) {
      ...
      for (u = 0; u < l; ++u)
        (c = n[u]) &&
          ((d[u] = f = rt + a.call(c, c.__data__, u, n)),
          f in s ? (i[u] = c) : (s[f] = c));
      for (u = 0; u < h; ++u)
    ...
    function zn(t) {
      ...
      var n,
        ...
        i = On(t.g),
        o = On(t.b),
        a = qn((0.2225045 * r + 0.7168786 * i + 0.0606169 * o) / Tn);
      return (
        r === i && i === o
          ? (n = e = a)
          : ((n = qn((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / An)),
            (e = qn((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / Sn))),
        new Dn(116 * a - 16, 500 * (n - a), 200 * (a - e), t.opacity)
      );
    }
    function Rn(t, n, e, r) {
    ...
    function Bn(t) {
      ...
      if ((t instanceof Dn || (t = zn(t)), 0 === t.a && 0 === t.b))
        return new Fn(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
    ...
    function ie(t, n) {
      var e = n - t;
      return e
        ? re(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
        : ee(isNaN(t) ? n : t);
    }
    function oe(t) {
      return 1 == (t = +t)
    ...
    function ye(t, n) {
      var e,
        ...
        u = [],
        c = [];
      for (t += "", n += ""; (e = ve.exec(t)) && (r = ge.exec(n)); )
        (i = r.index) > o &&
          ...
          (function(t, n, e, o) {
            t !== n
              ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
                o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: de(t, n) }))
              : n && e.push(i(e) + "rotate(" + n + r);
          })(o.rotate, a.rotate, u, c),
          (function(t, n, e, o) {
            t !== n
              ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: de(t, n) })
        ...
        function(t) {
          return "none" === t
            ...
            : (me ||
                ...
                (we = document.defaultView)),
              (me.style.transform = t),
              (t = we
                .getComputedStyle(xe.appendChild(me), null)
        ...
        function(t) {
          return null == t
            ...
            : (Me ||
              ...
              (t = Me.transform.baseVal.consolidate())
                ? Te((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f)
                : Ae);
        },
        ", ",
        ")",
        ...
        (r = (y - g) / Ce),
          (e = function(t) {
            var n,
              ...
              c =
                (a / (Pe * d)) *
                (u * ((n = Ce * e + g), ((n = Math.exp(2 * n)) - 1) / (n + 1)) -
                  (function(t) {
                    return ((t = Math.exp(t)) - 1 / t) / 2;
                  })(g));
    ...
    var Xe,
      ...
      Je = 0,
      Ke = 0,
      tr = "object" == typeof performance && performance.now ? performance : Date,
      nr =
    ...
    function ar() {
      er(), ++Ve;
      for (var t, n = Xe; n; )
        (t = Je - n._time) >= 0 && n._call.call(null, t), (n = n._next);
      --Ve;
    }
    function ur() {
    ...
    function fr(t) {
      Ve ||
        ($e && ($e = clearTimeout($e)),
        t - Je > 24
          ? (t < 1 / 0 && ($e = setTimeout(ur, t - tr.now() - Ke)),
            We && (We = clearInterval(We)))
          : (We || ((Qe = tr.now()), (We = setInterval(cr, Ze))),
            (Ve = 1),
            nr(ur)));
    }
    function sr(t, n, e) {
    ...
    ir.prototype = or.prototype = {
      ...
      restart: function(t, n, e) {
        ...
        (e = (null == e ? er() : +e) + (null == n ? 0 : +n)),
          this._next ||
            Ge === this ||
            (Ge ? (Ge._next = this) : (Xe = this), (Ge = this)),
          (this._call = t),
          (this._time = e),
          fr();
      },
      ...
      !(function(t, n, e) {
        ...
        function o(c) {
          ...
          if (
            (sr(function() {
              e.state === gr &&
                ((e.state = yr), e.timer.restart(a, e.delay, e.time), a(c));
            }),
            (e.state = vr),
            ...
            for (
              e.state = gr, r = new Array((l = e.tween.length)), f = 0, s = -1;
              f < l;
              ++f
            )
          ...
          for (
            var i =
                n < e.duration
                  ...
                  : (e.timer.restart(u), (e.state = _r), 1),
              o = -1,
              a = r.length;
            ++o < a;
    ...
    Cr.prototype = Pr.prototype = {
          ...
          ? this.styleTween(
              ...
              (function(t, n, e) {
                ...
                return function() {
                  ...
                  return (
                    null == u &&
                      (this.style.removeProperty(t), (c = u = ct(this, t))),
                    a === c
                      ? null
                      : a === r && c === i
                      ? o
      ...
      tween: function(t, n) {
        ...
        if (((t += ""), arguments.length < 2)) {
          for (
            var r, i = Mr(this.node(), e).tween, o = 0, a = i.length;
            o < a;
            ++o
          )
    ...
    var ni = (function t(n) {
      ...
      ci = { time: null, delay: 0, duration: 250, ease: qr };
    function fi(t, n) {
      for (var e; !(e = t.__transition) || !(e = e[n]); )
        if (!(t = t.parentNode)) return (ci.time = er()), ci;
      return e;
    }
    (Pt.prototype.interrupt = function(t) {
      ...
      (Pt.prototype.transition = function(t) {
        ...
        t instanceof Cr
          ? ((n = t._id), (t = t._name))
          : ((n = zr()), ((e = ci).time = er()), (t = null == t ? null : t + ""));
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
          for (var a, u = r[o], c = u.length, f = 0; f < c; ++f)
            (a = u[f]) && mr(a, t, n, f, u, e || fi(a, n));
    ...
    var vi = { name: "drag" },
      ...
      Mi = { e: "w", w: "e", nw: "ne", ne: "nw", se: "sw", sw: "se" },
      Ni = { n: "s", s: "n", nw: "sw", ne: "se", se: "ne", sw: "nw" },
      Ai = {
        overlay: 1,
        selection: 1,
        n: null,
    ...
    function zi(n) {
      ...
      function l() {
        ...
        if (i.apply(this, arguments)) {
          ...
          "overlay" === m
            ? (N.selection = T = [
                [(r = n === mi ? S : z[0]), (a = n === bi ? k : z[1])],
                [(s = n === mi ? E : r), (h = n === bi ? C : a)]
              ])
        ...
        function B() {
            ...
            case yi:
              w < 0
                ? ((p = Math.max(S - r, Math.min(E - r, p))),
                  ...
                  (l = s))
                : w > 0 &&
                  ((p = Math.max(S - s, Math.min(E - s, p))),
                  (o = r),
                  (l = s + p)),
                M < 0
                  ? ((v = Math.max(k - a, Math.min(C - a, v))),
                    (u = a + v),
                    (d = h))
                  : M > 0 &&
          ...
          l < o &&
            ...
            (o = l),
            (l = t),
            m in Mi && L.attr("cursor", wi[(m = Mi[m])])),
            d < u &&
              ((M *= -1),
              (t = a),
              (a = h),
              ...
              (u = d),
              (d = t),
              m in Ni && L.attr("cursor", wi[(m = Ni[m])])),
        ...
        function Y() {
          ...
          q.attr("pointer-events", "all"),
            L.attr("cursor", wi.overlay),
            N.selection && (T = N.selection),
            Pi(T) && ((N.selection = null), c.call(b)),
            D.end();
        }
      }
      function h() {
      ...
      return (
        (u.move = function(t, e) {
          t.selection
            ...
            : t.each(function() {
                ...
                Nr(this),
                  (r.selection = null == i || Pi(i) ? null : i),
                  c.call(this),
                  o
                    .start()
                    .brush()
        ...
        (s.prototype = {
          ...
          emit: function(t) {
            St(new hi(u, t, n.output(this.state.selection)), o.apply, o, [
              t,
              this.that,
              this.args
            ]);
        ...
        (u.extent = function(t) {
          return arguments.length
            ? ((r =
                "function" == typeof t
                  ? t
                  : li([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])),
              u)
            : r;
        }),
        (u.filter = function(t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : li(!!t)), u)
            : i;
        }),
    ...
    function vo() {
      ...
      function i(t) {
        var n = e(t);
        if (Array.isArray(n)) n = n.slice().sort(uo);
        else {
          var r = s(t),
            i = r[0],
            a = r[1];
      ...
      function o(e, i) {
        ...
        return (
          (function(e, r, i) {
            ...
            for (; ++o < t - 1; )
              (c = f), (f = e[o + 1] >= r), po[c | (f << 1)].forEach(p);
            po[f << 0].forEach(p);
            for (; ++u < n - 1; ) {
              for (
                o = -1,
          ...
          u.forEach(function(t) {
            for (var n, e = 0, r = o.length; e < r; ++e)
              if (-1 !== fo((n = o[e])[0], t)) return void n.push(t);
          }),
      ...
      function r(t, n) {
        ...
        function s() {
          ...
          if (t.charCodeAt(i) === Mo) {
            for (
              ;
              (a++ < o && t.charCodeAt(a) !== Mo) || t.charCodeAt(++a) === Mo;
            ...
            return (
              (n = a) >= o
                ...
                : (r = t.charCodeAt(a++)) === No
                ? (f = !0)
                : r === Ao && ((f = !0), t.charCodeAt(a) === No && ++a),
              t.slice(i + 1, n - 1).replace(/""/g, '"')
            );
          }
          for (; a < o; ) {
            if ((r = t.charCodeAt((n = a++))) === No) f = !0;
            else if (r === Ao) (f = !0), t.charCodeAt(a) === No && ++a;
        ...
        for (
          t.charCodeAt(o - 1) === No && --o, t.charCodeAt(o - 1) === Ao && --o;
          (r = s()) !== wo;
    ...
    (sa.copy = function() {
      ...
      (sa.visit = function(t) {
        var n,
          ...
          c = this._root;
        for (
          c && u.push(new ia(c, this._x0, this._y0, this._x1, this._y1));
          (n = u.pop());
          ...
          if (
            ...
            var f = (r + o) / 2,
              s = (i + a) / 2;
            (e = c[3]) && u.push(new ia(e, f, s, o, a)),
              (e = c[2]) && u.push(new ia(e, r, s, f, a)),
              (e = c[1]) && u.push(new ia(e, f, i, o, s)),
              (e = c[0]) && u.push(new ia(e, r, i, f, s));
          }
        return this;
      }),
      (sa.visitAfter = function(t) {
        ...
        for (
          this._root &&
          e.push(new ia(this._root, this._x0, this._y0, this._x1, this._y1));
          (n = e.pop());
          ...
          if (i.length) {
            var o,
              ...
              s = (a + c) / 2,
              l = (u + f) / 2;
            (o = i[0]) && e.push(new ia(o, a, u, s, l)),
              (o = i[1]) && e.push(new ia(o, s, u, c, l)),
              (o = i[2]) && e.push(new ia(o, a, l, s, f)),
              (o = i[3]) && e.push(new ia(o, s, l, c, f));
          }
          r.push(n);
        }
    ...
    var Ta = {
      ...
      s: function(t, n) {
        ...
        return o === a
          ...
          : "0." + new Array(1 - o).join("0") + ba(t, Math.max(0, n + o - 1))[0];
      },
      X: function(t) {
        return Math.round(t)
          .toString(16)
      ...
      function c(t) {
        ...
        function m(t) {
          ...
          switch (
            (h &&
              s &&
              ((t = r(N + t, N.length ? l - x.length : 1 / 0)), (N = "")),
            e)
          ) {
            case "<":
              t = m + t + x + N;
    ...
    function Pa(n) {
      return (
        (ka = Ca(n)),
        (t.format = ka.format),
        (t.formatPrefix = ka.formatPrefix),
        ka
      );
    }
    function za(t) {
    ...
    function Ra(t, n) {
      return Math.max(
        0,
        3 * Math.max(-8, Math.min(8, Math.floor(ma(n) / 3))) - ma(Math.abs(t))
      );
    }
    function Da(t, n) {
      return (
        (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, ma(n) - ma(t)) + 1
      );
    }
    function qa() {
      return new La();
    ...
    Pa({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""] }),
      (La.prototype = {
        constructor: La,
        reset: function() {
          this.s = this.t = 0;
        ...
        add: function(t) {
          Oa(Ua, t, this.t),
            Oa(this, Ua.s, this.s),
            this.s ? (this.t += Ua.t) : (this.s = Ua.t);
        },
        valueOf: function() {
          return this.s;
        }
    ...
    var vu,
      ...
      wu = {
        ...
        polygonEnd: function() {
          var t = +mu;
          xu.add(t < 0 ? Ha + t : t),
            (this.lineStart = this.lineEnd = this.point = cu);
        },
        sphere: function() {
          xu.add(Ha);
        }
    ...
    function fc(t, n) {
      ...
      if (Fu) {
        ...
        f ^ (u * Ou < c && c < u * t)
          ? (o = i[1] * Xa) > Uu && (Uu = o)
          : f ^ (u * Ou < (c = ((c + 360) % 360) - 180) && c < u * t)
          ? (o = -i[1] * Xa) < qu && (qu = o)
          : (n < qu && (qu = n), n > Uu && (Uu = n)),
          f
            ? t < Ou
              ? vc(Du, t) > vc(Du, Lu) && (Lu = t)
              : vc(t, Lu) > vc(Du, Lu) && (Du = t)
            : Lu >= Du
            ? (t < Du && (Du = t), t > Lu && (Lu = t))
            : t > Ou
            ? vc(Du, t) > vc(Du, Lu) && (Lu = t)
    ...
    function Lc(t) {
      ...
      return (
        (t = zc(t[0] * Ga, t[1] * Ga, t.length > 2 ? t[2] * Ga : 0)),
        (n.invert = function(n) {
        ...
        (t.forEach(function(t) {
          if (!((n = t.length - 1) <= 0)) {
            ...
            if (Yc(r, a)) {
              ...
              u.push((e = new Fc(r, t, null, !0))),
                c.push((e.o = new Fc(r, null, e, !1))),
                u.push((e = new Fc(a, t, null, !1))),
                c.push((e.o = new Fc(a, null, e, !0)));
          }
        }),
        u.length)
      ) {
        ...
        var o,
          ...
          h = {
            ...
            polygonEnd: function() {
              ...
              var t = Gc(o, r);
              a.length
                ? (l || (i.polygonStart(), (l = !0)), Ic(a, Wc, t, e, i))
                : t &&
    ...
    function Wc(t, n) {
      return (
        ((t = t.x)[0] < 0 ? t[1] - Ia - Ba : Ia - t[1]) -
        ((n = n.x)[0] < 0 ? n[1] - Ia - Ba : Ia - n[1])
      );
    }
    var Zc = Vc(
      function() {
          ...
          return {
            ...
            point: function(l, h) {
              ...
              if (
                (!n && (f = c = v) && t.lineStart(),
                v !== c &&
                  (!(d = a(n, p)) || Yc(n, d) || Yc(p, d)) &&
                  ((p[0] += Ba), (p[1] += Ba), (v = o(p[0], p[1]))),
                v !== c)
              )
                (s = 0),
                  v
      ...
      return function(a) {
        ...
        function M(o, a) {
          ...
          if ((f && s.push([o, a]), y))
            ...
            var c = [
                (p = Math.max(Kc, Math.min(Jc, p))),
                (v = Math.max(Kc, Math.min(Jc, v)))
              ],
              m = [
                (o = Math.max(Kc, Math.min(Jc, o))),
                (a = Math.max(Kc, Math.min(Jc, a)))
              ];
    ...
    var lf = [null, null],
      hf = { type: "LineString", coordinates: lf };
    function df(t, n) {
    ...
    function Nf() {
      ...
      function b() {
        return g(Qa(r / p) * p, e, p)
          .map(s)
          .concat(g(Qa(u / v) * v, a, v).map(l))
          .concat(
            g(Qa(n / h) * h, t, h)
              .filter(function(t) {
                return Va(t % p) > Ba;
      ...
      return (
        ...
        _.extentMajor([[-180, -90 + Ba], [180, 90 - Ba]]).extentMinor([
          [-180, -80 - Ba],
          [180, 80 + Ba]
        ])
      );
        ...
        switch (this._point) {
          ...
          default:
            this._context.moveTo(t + this._radius, n),
              this._context.arc(t, n, this._radius, 0, Ha);
        }
      },
      result: cu
    };
      ...
      point: function(t, n) {
        switch (this._point) {
          ...
          case 1:
            ...
            break;
          default:
            null == this._circle && (this._circle = ws(this._radius)),
      ...
      return +n
        ? (function(t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
              ...
              if (b > 4 * n && v--) {
                var m = a + h,
                  ...
                  N = au((w /= M)),
                  A =
                    Va(Va(w) - 1) < Ba || Va(o - l) < Ba ? (o + l) / 2 : Wa(x, m),
                  T = t(A, N),
                  S = T[0],
                  k = T[1],
                  E = S - r,
            ...
            return function(n) {
              ...
              function w() {
                e(s, l, f, h, d, p, i, o, r, a, u, c, Cs, n),
                  (v.lineEnd = b),
                  b();
              }
              return v;
    ...
    function Ls(t) {
      ...
      function S() {
        ...
        return (
          (e = zc(g, y, _)), (u = Cc(n, r)), (c = Cc(e, u)), (a = zs(u, N)), k()
        );
      }
      function k() {
        return (f = s = null), A;
    ...
    function el(t, n) {
      var e = au(nl * nu(n)),
        ...
        i = r * r * r;
      return [
        (t * Za(e)) / (nl * (Qs + 3 * Js * r + i * (7 * Ks + 9 * tl * r))),
        e * (Qs + Js * r + i * (Ks + tl * r))
      ];
    }
    function rl(t, n) {
    ...
    (el.invert = function(t, n) {
      for (
        ...
        ((o =
          (i =
            (r -= e =
              (r * (Qs + Js * i + o * (Ks + tl * i)) - n) /
              (Qs + 3 * Js * i + o * (7 * Ks + 9 * tl * i))) * r) *
          i *
          i),
        !(Va(e) < Ya));
        ++a
      ...
      return [
        (nl * t * (Qs + 3 * Js * i + o * (7 * Ks + 9 * tl * i))) / Za(r),
        au(nu(r) / nl)
      ];
    }),
      (rl.invert = Is($a)),
    ...
    function bl(t) {
      for (
        ...
        (n = t[r]), e && wl(e, n) ? ++r : ((e = Nl((o = ml(o, n)))), (r = 0));
      return e;
    }
    function ml(t, n) {
      var e, r;
      ...
      for (e = 0; e < t.length; ++e)
        if (xl(n, t[e]) && Ml(Al(t[e], n), t)) return [t[e], n];
    ...
    function Pl(t) {
      ...
      t: for (u = 3; u < i; ++u) {
        ...
        for (
          r.previous = n, r.next = e, n.next = e.previous = e = r, o = El(n);
          (r = r.next) !== e;
    ...
    function th(t, n, e, r, i, o) {
      for (
        ...
        y.push((a = { value: s, dice: c < f, children: _.slice(b, m) })),
          a.dice
            ? Yl(a, e, r, i, w ? (r += (f * s) / w) : o)
            : Jl(a, e, r, w ? (e += (c * s) / w) : i, o),
          (w -= s),
          (b = m);
      }
      return y;
        ...
        if ((a = t._squarify) && a.ratio === n)
          for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
            for (
              ...
              u.value += c[f].value;
            u.dice
              ? Yl(u, e, r, i, (r += ((o - r) * u.value) / d))
              : Jl(u, e, r, (e += ((i - e) * u.value) / d), o),
              (d -= u.value);
          }
    ...
    function Ah(t, n, e) {
      var r = t[0],
        ...
        a = n[1];
      return (
        i < r ? ((r = Mh(i, r)), (o = e(a, o))) : ((r = Mh(r, i)), (o = e(o, a))),
        function(t) {
          return o(r(t));
        }
      );
    ...
    function Th(t, n, e) {
      ...
      for (
        ...
        (o[u] = Mh(t[u], t[u + 1])), (a[u] = e(n[u], n[u + 1]));
      return function(n) {
        var e = i(t, n, 1, r) - 1;
        return a[e](o[e](n));
      };
    ...
    function kh() {
      ...
      function s() {
        return (
          (r = Math.min(a.length, u.length) > 2 ? Th : Ah), (i = o = null), l
        );
      }
      function l(n) {
    ...
    function Ch(n, e, r, i) {
      ...
      switch ((i = Ma(null == i ? ",f" : i)).type) {
        case "s":
          ...
          return (
            null != i.precision || isNaN((o = Ra(a, u))) || (i.precision = o),
            t.formatPrefix(i, u)
          );
        case "":
        case "e":
        ...
        case "r":
          null != i.precision ||
            isNaN((o = Da(a, Math.max(Math.abs(n), Math.abs(e))))) ||
    ...
    function Bh(n) {
      ...
      function u() {
        return (
          ...
          o()[0] < 0 ? ((e = Oh(e)), (r = Oh(r)), n(qh, Lh)) : n(Rh, Dh),
          i
        );
      }
      return (
      ...
      return (
        ...
        e &&
          ((i.count = function(n, r) {
            return (
              $h.setTime(+n), Wh.setTime(+r), t($h), t(Wh), Math.floor(e($h, Wh))
            );
          }),
          (i.every = function(t) {
            return (
    ...
    var Jh = Qh.range,
      ...
      od = Zh(
        function(t) {
          t.setTime(
            t - t.getMilliseconds() - 1e3 * t.getSeconds() - t.getMinutes() * Kh
          );
        },
        function(t, n) {
          t.setTime(+t + 36e5 * n);
      ...
      ud = Zh(
        ...
        function(t, n) {
          return (
            (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Kh) / 864e5
          );
        },
        function(t) {
          return t.getDate() - 1;
    ...
    function fd(t) {
      return Zh(
        ...
        function(t, n) {
          return (
            (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Kh) / td
          );
        }
      );
    }
      ...
      function M(t, n) {
        return function(e) {
          ...
          if (("p" in o && (o.H = (o.H % 12) + 12 * o.p), "V" in o)) {
            ...
            "w" in o || (o.w = 1),
              "Z" in o
                ? ((i = (r = tp(np(o.y))).getUTCDay()),
                  (r = i > 4 || 0 === i ? Ld.ceil(r) : Ld(r)),
                  (r = zd.offset(r, 7 * (o.V - 1))),
                  (o.y = r.getUTCFullYear()),
                  (o.m = r.getUTCMonth()),
                  (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
                : ((i = (r = n(np(o.y))).getDay()),
                  (r = i > 4 || 0 === i ? ld.ceil(r) : ld(r)),
                  (r = ud.offset(r, 7 * (o.V - 1))),
                  (o.y = r.getFullYear()),
                  (o.m = r.getMonth()),
          ...
          return "Z" in o
            ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), tp(o))
            : n(o);
        };
      }
      function N(t, n, e, r) {
        for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
          ...
          if (37 === (i = n.charCodeAt(a++))) {
            if (
              ((i = n.charAt(a++)),
              !(o = x[i in ip ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
            )
              return -1;
    ...
    function Ip(t, n) {
      ...
      return (
        ...
        cp(pd.count(Td(t), t) + (4 === Td(t).getDay()), n, 2)
      );
    }
    function jp(t) {
      return t.getDay();
    ...
    function ov(t, n) {
      var e = t.getUTCDay();
      return (
        (t = e >= 4 || 0 === e ? Bd(t) : Bd.ceil(t)),
        cp(Bd.count(Qd(t), t) + (4 === Qd(t).getUTCDay()), n, 2)
      );
    }
    function av(t) {
      return t.getUTCDay();
    ...
    function pv(n) {
      return (
        (rp = ep(n)),
        (t.timeFormat = rp.format),
        (t.timeParse = rp.parse),
        (t.utcFormat = rp.utcFormat),
        (t.utcParse = rp.utcParse),
        rp
      );
    }
    pv({
    ...
    var gv = +new Date("2000-01-01T00:00:00.000Z")
        ? function(t) {
            var n = new Date(t);
    ...
    var jv = new Array(3)
      ...
      Fg = new Array(3)
        ...
        .map(zv),
      Ig = Iv(Fg),
      jg = He(Qn(300, 0.5, 0), Qn(-240, 0.5, 1)),
      Hg = He(Qn(-100, 0.75, 0.35), Qn(80, 1.5, 0.8)),
      Xg = He(Qn(260, 0.75, 0.35), Qn(80, 1.5, 0.8)),
      Gg = Qn();
    var Vg = gn(),
      $g = Math.PI / 3,
      Wg = (2 * Math.PI) / 3;
    ...
    function Ny() {
      ...
      return (
        (a.x = function(n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : ny(+n)), a)
            : t;
        }),
        (a.y = function(t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : ny(+t)), a)
            : n;
        }),
        (a.defined = function(t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : ny(!!t)), a)
            : e;
        }),
        (a.curve = function(t) {
    ...
    function Ay() {
      ...
      return (
        (c.x = function(e) {
          return arguments.length
            ? ((t = "function" == typeof e ? e : ny(+e)), (n = null), c)
            : t;
        }),
        (c.x0 = function(n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : ny(+n)), c)
            : t;
        }),
        (c.x1 = function(t) {
          return arguments.length
            ? ((n = null == t ? null : "function" == typeof t ? t : ny(+t)), c)
            : n;
        }),
        (c.y = function(t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : ny(+t)), (r = null), c)
            : e;
        }),
        (c.y0 = function(t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : ny(+t)), c)
            : e;
        }),
        (c.y1 = function(t) {
          return arguments.length
            ? ((r = null == t ? null : "function" == typeof t ? t : ny(+t)), c)
            : r;
        }),
    ...
    function Oy(t) {
      ...
      return (
        ...
        (a.x = function(t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : ny(+t)), a)
            : r;
        }),
        (a.y = function(t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : ny(+t)), a)
            : i;
        }),
        (a.context = function(t) {
      ...
      r_ = {
        draw: function(t, n) {
          ...
          t.moveTo(r, i),
            t.lineTo(o, a),
            t.lineTo(u, c),
            t.lineTo(-0.5 * r - t_ * i, t_ * r + -0.5 * i),
            t.lineTo(-0.5 * o - t_ * a, t_ * o + -0.5 * a),
            t.lineTo(-0.5 * u - t_ * c, t_ * u + -0.5 * c),
            t.lineTo(-0.5 * r + t_ * i, -0.5 * i - t_ * r),
            t.lineTo(-0.5 * o + t_ * a, -0.5 * a - t_ * o),
            t.lineTo(-0.5 * u + t_ * c, -0.5 * c - t_ * u),
            t.closePath();
        }
      },
    ...
    function k_(t, n, e) {
      var r = t._x1 - t._x0,
        ...
        u = (o * i + a * r) / (r + i);
      return (
        (S_(o) + S_(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
        0
      );
    }
    function E_(t, n) {
    ...
    function J_(t, n, e, r) {
      ...
      return (
        ...
        e && tb(i, t, n, e),
        r && tb(i, n, t, r),
        mb[t.index].halfedges.push(o),
        mb[n.index].halfedges.push(o),
        i
      );
    }
    function K_(t, n, e) {
        ...
        insert: function(t, n) {
          ...
          for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
            e === (r = e.U).L
              ? (i = r.R) && i.C
                ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                : (t === e.R && (W_(this, e), (e = (t = e).U)),
                  (e.C = !1),
                  (r.C = !0),
                  Z_(this, r))
              : (i = r.L) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.L && (Z_(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                W_(this, r)),
              (e = t.U);
            ...
            if (t && t.C) t.C = !1;
              ...
              do {
                ...
                if (t === i.L) {
                  if (
                    ((n = i.R).C &&
                      ((n.C = !1), (i.C = !0), W_(this, i), (n = i.R)),
                    (n.L && n.L.C) || (n.R && n.R.C))
                  ) {
                    (n.R && n.R.C) ||
                      ((n.L.C = !1), (n.C = !0), Z_(this, n), (n = i.R)),
                      (n.C = i.C),
                      (i.C = n.R.C = !1),
                      W_(this, i),
                      (t = this._);
                  ...
                  ((n = i.L).C &&
                    ((n.C = !1), (i.C = !0), Z_(this, i), (n = i.L)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.L && n.L.C) ||
                    ((n.R.C = !1), (n.C = !0), W_(this, n), (n = i.L)),
                    (n.C = i.C),
                    (i.C = n.L.C = !1),
                    Z_(this, i),
                    (t = this._);
    ...
    function sb(t) {
      var n = t.circle;
      n &&
        (n.P || (ab = n.N), xb.remove(n), ub.push(n), $_(n), (t.circle = null));
    }
    var lb = [];
    function hb() {
    ...
    function vb(t) {
      ...
      for (
        var c = o;
        c.circle &&
        Math.abs(e - c.circle.x) < Mb &&
        Math.abs(r - c.circle.cy) < Mb;
  
      )
        (o = c.P), u.unshift(c), pb(c), (c = o);
      u.unshift(c), sb(c);
      for (
        var f = a;
        f.circle &&
        Math.abs(e - f.circle.x) < Mb &&
        Math.abs(r - f.circle.cy) < Mb;
  
      )
        (a = f.N), u.push(f), pb(f), (f = a);
      u.push(f), sb(f);
      var s,
        l = u.length;
      for (s = 1; s < l; ++s)
        (f = u[s]), (c = u[s - 1]), tb(f.edge, c.site, f.site, i);
      (c = u[0]),
        ((f = u[l - 1]).edge = J_(c.site, f.site, null, i)),
        fb(c),
        fb(f);
    }
    function gb(t) {
      for (var n, e, r, i, o = t[0], a = t[1], u = bb._; u; )
        if ((r = yb(u, a) - o) > Mb) u = u.L;
        else {
          if (!((i = o - _b(u, a)) > Mb)) {
            r > -Mb
              ? ((n = u.P), (e = u))
      ...
      if ((bb.insert(n, c), n || e)) {
        ...
        if (e) {
          ...
          tb(e.edge, f, p, m),
            (c.edge = J_(f, t, null, m)),
            (e.edge = J_(t, p, null, m)),
            fb(n),
            fb(e);
    ...
    function Tb(t, n) {
      var e,
        ...
        i,
        o = t.sort(Ab).pop();
      for (wb = [], mb = new Array(t.length), bb = new V_(), xb = new V_(); ; )
        if (((i = ab), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
          (o[0] === e && o[1] === r) || (gb(o), (e = o[0]), (r = o[1])),
            (o = t.pop());
        else {
          if (!i) break;
          vb(i.arc);
      ...
      if (
        ((function() {
          for (var t, n, e, r, i = 0, o = mb.length; i < o; ++i)
        ...
        var a = +n[0][0],
          ...
          f = +n[1][1];
        !(function(t, n, e, r) {
          for (var i, o = wb.length; o--; )
            (eb((i = wb[o]), t, n, e, r) &&
              nb(i, t, n, e, r) &&
              (Math.abs(i[0][0] - i[1][0]) > Mb ||
                Math.abs(i[0][1] - i[1][1]) > Mb)) ||
              delete wb[o];
        })(a, u, c, f),
          (function(t, n, e, r) {
            var i,
              ...
              if ((o = mb[i])) {
                ...
                for (u = 0, f = c.length; u < f; )
                  (p = (d = ob(o, wb[c[u]]))[0]),
                    ...
                    (l = (s = ib(o, wb[c[++u % f]]))[0]),
                    (h = s[1]),
                    (Math.abs(p - l) > Mb || Math.abs(v - h) > Mb) &&
                      (c.splice(
                        u,
                        0,
                        wb.push(
                          K_(
                            a,
                            d,
                            Math.abs(p - t) < Mb && r - v > Mb
                              ? [t, Math.abs(l - t) < Mb ? h : r]
                              : Math.abs(v - r) < Mb && e - p > Mb
                              ? [Math.abs(h - r) < Mb ? l : e, r]
                              : Math.abs(p - e) < Mb && v - n > Mb
                              ? [e, Math.abs(l - e) < Mb ? h : n]
                              : Math.abs(v - n) < Mb && p - t > Mb
                              ? [Math.abs(h - n) < Mb ? l : t, n]
                              : null
                          )
                        ) - 1
                      ),
            ...
            for (i = 0; i < g; ++i)
              (o = mb[i]) && (o.halfedges.length || delete mb[i]);
          })(a, u, c, f);
      }
    ...
    (Tb.prototype = {
      ...
      (Eb.prototype = {
        ...
        translate: function(t, n) {
          return (0 === t) & (0 === n)
            ? this
            : new Eb(this.k, this.x + this.k * t, this.y + this.k * n);
        },
        apply: function(t) {
    ...
    (Pb.prototype = Eb.prototype),
      ...
      (t.ribbon = function() {
        ...
        function a() {
          ...
          if (
            ...
            o.arc(0, 0, s, l, h),
            (l === g && h === y) ||
              (o.quadraticCurveTo(0, 0, v * Ri(g), v * Di(g)),
              o.arc(0, 0, v, g, y)),
        ...
        return (
          (a.radius = function(t) {
            return arguments.length
              ? ((e = "function" == typeof t ? t : Yi(+t)), a)
              : e;
          }),
          (a.startAngle = function(t) {
            return arguments.length
              ? ((r = "function" == typeof t ? t : Yi(+t)), a)
              : r;
          }),
          (a.endAngle = function(t) {
            return arguments.length
              ? ((i = "function" == typeof t ? t : Yi(+t)), a)
              : i;
          }),
          (a.source = function(n) {
      ...
      (t.nest = function() {
        ...
        function o(e, i, a, u) {
          ...
          for (
            var c, f, s, l = -1, h = e.length, d = r[i++], p = Ji(), v = a();
            ++l < h;
      ...
      (t.drag = function() {
        ...
        function y() {
          if (o.apply(this, arguments)) {
            var n,
              ...
              u = r.length;
            for (n = 0; n < u; ++n)
              (e = m(r[n].identifier, i, Bt, this, arguments)) &&
                (Yt(), e("start"));
          }
        }
        function _() {
        ...
        function m(n, e, r, i, o) {
          ...
          if (
            St(
              new Xt(d, "beforestart", a, n, l, p[0], p[1], 0, 0, v),
              function() {
                return (
        ...
        return (
          (d.filter = function(t) {
            return arguments.length
              ? ((o = "function" == typeof t ? t : Ht(!!t)), d)
              : o;
          }),
          (d.container = function(t) {
            return arguments.length
              ? ((a = "function" == typeof t ? t : Ht(t)), d)
              : a;
          }),
          (d.subject = function(t) {
            return arguments.length
              ? ((u = "function" == typeof t ? t : Ht(t)), d)
              : u;
          }),
          (d.touchable = function(t) {
            return arguments.length
              ? ((c = "function" == typeof t ? t : Ht(!!t)), d)
              : c;
          }),
          (d.on = function() {
      ...
      (t.forceCollide = function(t) {
        ...
        return (
          "function" != typeof t && (t = na(null == t ? 1 : +t)),
          ...
          (o.radius = function(n) {
            return arguments.length
              ? ((t = "function" == typeof n ? n : na(+n)), u(), o)
              : t;
          }),
          o
        );
      ...
      (t.forceLink = function(t) {
        ...
        function s(r) {
          for (var i = 0, a = t.length; i < f; ++i)
            for (var u, c, s, l, h, d, p, v = 0; v < a; ++v)
              (c = (u = t[v]).source),
                (l = (s = u.target).x + s.vx - c.x - c.vx || ea()),
                (h = s.y + s.vy - c.y - c.vy || ea()),
                (l *= d =
        ...
        function l() {
          if (r) {
            ...
            for (u = 0, i = new Array(f); u < s; ++u)
              ((c = t[u]).index = u),
                "object" != typeof c.source && (c.source = pa(l, c.source)),
                "object" != typeof c.target && (c.target = pa(l, c.target)),
        ...
        return (
          ...
          (s.strength = function(t) {
            return arguments.length
              ? ((u = "function" == typeof t ? t : na(+t)), h(), s)
              : u;
          }),
          (s.distance = function(t) {
            return arguments.length
              ? ((c = "function" == typeof t ? t : na(+t)), d(), s)
              : c;
          }),
          s
        );
      ...
      (t.forceManyBody = function() {
        ...
        return (
          ...
          (c.strength = function(t) {
            return arguments.length
              ? ((i = "function" == typeof t ? t : na(+t)), f(), c)
              : i;
          }),
      ...
      (t.forceRadial = function(t, n, e) {
        ...
        return (
          ...
          (u.strength = function(t) {
            return arguments.length
              ? ((a = "function" == typeof t ? t : na(+t)), c(), u)
              : a;
          }),
          (u.radius = function(n) {
            return arguments.length
              ? ((t = "function" == typeof n ? n : na(+n)), c(), u)
              : t;
          }),
          (u.x = function(t) {
      ...
      (t.forceX = function(t) {
        ...
        return (
          "function" != typeof t && (t = na(null == t ? 0 : +t)),
          (o.initialize = function(t) {
            (n = t), a();
          }),
          (o.strength = function(t) {
            return arguments.length
              ? ((i = "function" == typeof t ? t : na(+t)), a(), o)
              : i;
          }),
          (o.x = function(n) {
            return arguments.length
              ? ((t = "function" == typeof n ? n : na(+n)), a(), o)
              : t;
          }),
          o
        );
      ...
      (t.formatDefaultLocale = Pa),
      (t.formatLocale = Ca),
      (t.formatSpecifier = Ma),
      (t.precisionFixed = za),
      (t.precisionPrefix = Ra),
      (t.precisionRound = Da),
      ...
      (t.geoBounds = function(t) {
        var n, e, r, i, o, a, u;
        if (
          ((Uu = Lu = -(Du = qu = 1 / 0)), (Iu = []), pu(t, uc), (e = Iu.length))
        ) {
          for (Iu.sort(gc), n = 1, o = [(r = Iu[0])]; n < e; ++n)
            yc(r, (i = Iu[n])[0]) || yc(r, i[1])
              ? (vc(r[0], i[1]) > vc(r[0], r[1]) && (r[1] = i[1]),
                vc(i[0], r[1]) > vc(r[0], r[1]) && (r[0] = i[0]))
              : o.push((r = i));
          for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
            (i = o[n]),
              (u = vc(r[1], i[0])) > a && ((a = u), (Du = i[0]), (Lu = r[1]));
        }
        return (
          (Iu = ju = null),
          Du === 1 / 0 || qu === 1 / 0
      ...
      (t.geoCircle = function() {
        ...
        return (
          (a.center = function(t) {
            return arguments.length
              ? ((e = "function" == typeof t ? t : Ec([+t[0], +t[1]])), a)
              : e;
          }),
          (a.radius = function(t) {
            return arguments.length
              ? ((r = "function" == typeof t ? t : Ec(+t)), a)
              : r;
          }),
          (a.precision = function(t) {
            return arguments.length
              ? ((i = "function" == typeof t ? t : Ec(+t)), a)
              : i;
          }),
          a
        );
      }),
      (t.geoClipAntimeridian = Zc),
      (t.geoClipCircle = Qc),
      ...
      (t.geoPath = function(t, n) {
        ...
        return (
          ...
          (o.projection = function(n) {
            return arguments.length
              ? ((e = null == n ? ((t = null), Af) : (t = n).stream), o)
              : t;
          }),
          (o.context = function(t) {
            return arguments.length
              ? ((r = null == t ? ((n = null), new xs()) : new ls((n = t))),
          ...
          (s.translate = function(t) {
            ...
            return (
              ...
              (r = u
                ...
                .clipExtent([
                  [o - 0.425 * n + Ba, s + 0.12 * n + Ba],
                  [o - 0.214 * n - Ba, s + 0.234 * n - Ba]
                ])
                .stream(f)),
              (i = c
                .translate([o - 0.205 * n, s + 0.212 * n])
                .clipExtent([
                  [o - 0.214 * n + Ba, s + 0.166 * n + Ba],
                  [o - 0.115 * n - Ba, s + 0.234 * n - Ba]
                ])
                .stream(f)),
              l()
            );
      ...
      (t.geoAzimuthalEquidistantRaw = Hs),
      (t.geoConicConformal = function() {
        return Us($s)
          .scale(109.5)
          .parallels([30, 30]);
      }),
      (t.geoConicConformalRaw = $s),
      (t.geoConicEqualArea = Bs),
      (t.geoConicEqualAreaRaw = Os),
      (t.geoConicEquidistant = function() {
        return Us(Zs)
          .scale(131.154)
          .center([0, 13.9389]);
      }),
      (t.geoConicEquidistantRaw = Zs),
      (t.geoEqualEarth = function() {
        return qs(el).scale(177.158);
      }),
      (t.geoEqualEarthRaw = el),
      (t.geoEquirectangular = function() {
        return qs(Ws).scale(152.63);
      }),
      (t.geoEquirectangularRaw = Ws),
      ...
      (t.geoIdentity = function() {
        ...
        return (o = {
          ...
          scale: function(t) {
            return arguments.length
              ? ((l = il((a = +t) * f, a * s, u, c)), p())
              : a;
          },
          translate: function(t) {
            return arguments.length
              ? ((l = il(a * f, a * s, (u = +t[0]), (c = +t[1]))), p())
              : [u, c];
          },
          reflectX: function(t) {
            return arguments.length
              ? ((l = il(a * (f = t ? -1 : 1), a * s, u, c)), p())
              : f < 0;
          },
          reflectY: function(t) {
            return arguments.length
              ? ((l = il(a * f, a * (s = t ? -1 : 1), u, c)), p())
              : s < 0;
          },
      ...
      (t.geoNaturalEarth1Raw = ol),
      (t.geoOrthographic = function() {
        return qs(al)
          .scale(249.5)
          .clipAngle(90 + Ba);
      }),
      (t.geoOrthographicRaw = al),
      (t.geoStereographic = function() {
        return qs(ul)
          .scale(250)
          .clipAngle(142);
      }),
      (t.geoStereographicRaw = ul),
          ...
          return (
            ...
            t
              ...
              : i
                  .eachBefore(Ll(ql))
                  .eachAfter(Ul(Rl, 1))
                  .eachAfter(Ul(r, i.r / Math.min(n, e)))
                  .eachBefore(Ol(Math.min(n, e) / (2 * i.r))),
            i
          );
        }
        return (
      ...
      (t.tree = function() {
        ...
        function i(i) {
          var c = (function(t) {
            for (var n, e, r, i, o, a = new Ql(t, 0), u = [a]; (n = u.pop()); )
              if ((r = n._.children))
                for (
                  ...
                  u.push((e = n.children[i] = new Ql(r[i], i))), (e.parent = n);
              ...
              for (
                ...
                (c = Vl(c)),
                  ...
                  (i = u.z + l - o.z - f + t(u._, o._)) > 0 &&
                    (Wl(Zl(u, n, r), n, i), (f += i), (s += i)),
                  (l += u.m),
                  (f += o.m),
                  (h += c.m),
                  (s += a.m);
              u && !$l(a) && ((a.t = u), (a.m += l - s)),
                o && !Vl(c) && ((c.t = o), (c.m += f - h), (r = n));
            }
            return r;
          })(n, i, n.parent.A || r[0]);
        }
      ...
      (t.treemap = function() {
        ...
        return (
          ...
          (s.paddingTop = function(t) {
            return arguments.length
              ? ((a = "function" == typeof t ? t : Dl(+t)), s)
              : a;
          }),
          (s.paddingRight = function(t) {
            return arguments.length
              ? ((u = "function" == typeof t ? t : Dl(+t)), s)
              : u;
          }),
          (s.paddingBottom = function(t) {
            return arguments.length
              ? ((c = "function" == typeof t ? t : Dl(+t)), s)
              : c;
          }),
          (s.paddingLeft = function(t) {
            return arguments.length
              ? ((f = "function" == typeof t ? t : Dl(+t)), s)
              : f;
          }),
          s
        );
      ...
      (t.treemapSquarify = nh),
      (t.treemapResquarify = eh),
      (t.interpolate = _e),
      (t.interpolateArray = le),
      (t.interpolateBasis = te),
      (t.interpolateBasisClosed = ne),
      (t.interpolateDate = he),
      ...
      (t.interpolateObject = pe),
      (t.interpolateRound = be),
      (t.interpolateString = ye),
      (t.interpolateTransformCss = ke),
      (t.interpolateTransformSvg = Ee),
      (t.interpolateZoom = qe),
      (t.interpolateRgb = ue),
      (t.interpolateRgbBasis = fe),
      (t.interpolateRgbBasisClosed = se),
      (t.interpolateHsl = Ue),
      (t.interpolateHslLong = Oe),
      ...
      (t.randomUniform = ah),
      (t.randomNormal = uh),
      (t.randomLogNormal = ch),
      (t.randomBates = sh),
      (t.randomIrwinHall = fh),
      (t.randomExponential = lh),
      (t.scaleBand = bh),
      ...
      (t.scaleIdentity = function t(n) {
        ...
        return (
          ...
          (n = arguments.length ? vh.call(n, mh) : [0, 1]),
          Ph(r)
        );
      }),
      ...
      (t.scaleThreshold = function t() {
        ...
        return (
          (a.domain = function(t) {
            return arguments.length
              ? ((e = gh.call(t)), (o = Math.min(e.length, r.length - 1)), a)
              : e.slice();
          }),
          (a.range = function(t) {
            return arguments.length
              ? ((r = gh.call(t)), (o = Math.min(e.length, r.length - 1)), a)
              : r.slice();
          }),
      ...
      (t.scaleTime = function() {
        return hh.apply(
          Tv(Td, Nd, sd, ud, od, rd, nd, Qh, t.timeFormat).domain([
            new Date(2e3, 0, 1),
            new Date(2e3, 0, 2)
          ]),
          arguments
      ...
      (t.scaleUtc = function() {
        return hh.apply(
          Tv(Qd, Wd, qd, zd, Cd, kd, nd, Qh, t.utcFormat).domain([
            Date.UTC(2e3, 0, 1),
            Date.UTC(2e3, 0, 2)
          ]),
          arguments
      ...
      (t.schemeSet2 = Yv),
      (t.schemeSet3 = Fv),
      (t.interpolateBrBG = Hv),
      (t.schemeBrBG = jv),
      (t.interpolatePRGn = Gv),
      (t.schemePRGn = Xv),
      (t.interpolatePiYG = $v),
      (t.schemePiYG = Vv),
      (t.interpolatePuOr = Zv),
      (t.schemePuOr = Wv),
      (t.interpolateRdBu = Jv),
      (t.schemeRdBu = Qv),
      (t.interpolateRdGy = tg),
      (t.schemeRdGy = Kv),
      (t.interpolateRdYlBu = eg),
      (t.schemeRdYlBu = ng),
      (t.interpolateRdYlGn = ig),
      (t.schemeRdYlGn = rg),
      (t.interpolateSpectral = ag),
      (t.schemeSpectral = og),
      (t.interpolateBuGn = cg),
      (t.schemeBuGn = ug),
      (t.interpolateBuPu = sg),
      (t.schemeBuPu = fg),
      (t.interpolateGnBu = hg),
      (t.schemeGnBu = lg),
      (t.interpolateOrRd = pg),
      (t.schemeOrRd = dg),
      (t.interpolatePuBuGn = gg),
      (t.schemePuBuGn = vg),
      (t.interpolatePuBu = _g),
      (t.schemePuBu = yg),
      (t.interpolatePuRd = mg),
      (t.schemePuRd = bg),
      (t.interpolateRdPu = wg),
      (t.schemeRdPu = xg),
      (t.interpolateYlGnBu = Ng),
      (t.schemeYlGnBu = Mg),
      (t.interpolateYlGn = Tg),
      (t.schemeYlGn = Ag),
      (t.interpolateYlOrBr = kg),
      (t.schemeYlOrBr = Sg),
      (t.interpolateYlOrRd = Cg),
      (t.schemeYlOrRd = Eg),
      (t.interpolateBlues = zg),
      (t.schemeBlues = Pg),
      (t.interpolateGreens = Dg),
      (t.schemeGreens = Rg),
      (t.interpolateGreys = Lg),
      (t.schemeGreys = qg),
      (t.interpolatePurples = Og),
      (t.schemePurples = Ug),
      (t.interpolateReds = Yg),
      (t.schemeReds = Bg),
      (t.interpolateOranges = Ig),
      (t.schemeOranges = Fg),
      (t.interpolateCubehelixDefault = jg),
      ...
      (t.interpolateWarm = Hg),
      (t.interpolateCool = Xg),
      (t.interpolateSinebow = function(t) {
        var n;
        return (
          (t = (0.5 - t) * Math.PI),
          (Vg.r = 255 * (n = Math.sin(t)) * n),
          (Vg.g = 255 * (n = Math.sin(t + $g)) * n),
          (Vg.b = 255 * (n = Math.sin(t + Wg)) * n),
          Vg + ""
        );
      }),
      (t.interpolateViridis = Qg),
      (t.interpolateMagma = Jg),
      (t.interpolateInferno = Kg),
      (t.interpolatePlasma = ty),
      (t.create = function(t) {
      ...
      (t.arc = function() {
        ...
        function c() {
          ...
          if ((u || (u = c = Xi()), h < l && ((f = h), (h = l), (l = f)), h > fy))
            if (v > hy - fy)
              u.moveTo(h * iy(d), h * uy(d)),
                u.arc(0, 0, h, d, p, !g),
                l > fy &&
                  (u.moveTo(l * iy(p), l * uy(p)), u.arc(0, 0, l, p, d, g));
            else {
              var y,
                _,
                b = d,
                    ...
                    E < S
                      ...
                      : (u.arc(
                        ...
                        u.arc(
                          ...
                          0,
                          h,
                          ry(y.cy + y.y11, y.cx + y.x11),
                          ry(_.cy + _.y11, _.cx + _.x11),
                          !g
                        ),
                        u.arc(
                          _.cx,
        ...
        return (
          ...
          (c.endAngle = function(t) {
            return arguments.length
              ? ((o = "function" == typeof t ? t : ny(+t)), c)
              : o;
          }),
          (c.padAngle = function(t) {
            return arguments.length
              ? ((a = "function" == typeof t ? t : ny(+t)), c)
              : a;
          }),
          (c.context = function(t) {
      ...
      (t.symbol = function() {
        ...
        return (
          (r.type = function(n) {
            return arguments.length
              ? ((t = "function" == typeof n ? n : ny(n)), r)
              : t;
          }),
          (r.size = function(t) {
            return arguments.length
              ? ((n = "function" == typeof t ? t : ny(+t)), r)
              : n;
          }),
      ...
      (t.curveBundle = l_),
      (t.curveCardinalClosed = g_),
      (t.curveCardinalOpen = __),
      (t.curveCardinal = p_),
      (t.curveCatmullRomClosed = M_),
      (t.curveCatmullRomOpen = A_),
      (t.curveCatmullRom = x_),
      ...
      (t.stack = function() {
        ...
        return (
          (i.keys = function(n) {
            return arguments.length
              ? ((t = "function" == typeof n ? n : ny(qy.call(n))), i)
              : t;
          }),
          (i.value = function(t) {
            return arguments.length
              ? ((r = "function" == typeof t ? t : ny(+t)), i)
              : r;
          }),
          (i.order = function(t) {
            return arguments.length
              ? ((n =
                  null == t ? O_ : "function" == typeof t ? t : ny(qy.call(t))),
                i)
              : n;
          }),
          (i.offset = function(t) {
      ...
      (t.stackOrderAppearance = Y_),
      (t.stackOrderAscending = I_),
      ...
      (t.timeInterval = Zh),
      (t.timeMillisecond = Qh),
      (t.timeMilliseconds = Jh),
      (t.utcMillisecond = Qh),
      (t.utcMilliseconds = Jh),
      (t.timeSecond = nd),
      (t.timeSeconds = ed),
      (t.utcSecond = nd),
      (t.utcSeconds = ed),
      ...
      (t.voronoi = function() {
        ...
        function r(r) {
          return new Tb(
            r.map(function(e, i) {
              var o = [
                Math.round(t(e, i, r) / Mb) * Mb,
                Math.round(n(e, i, r) / Mb) * Mb
              ];
        ...
        return (
          ...
          (r.x = function(n) {
            return arguments.length
              ? ((t = "function" == typeof n ? n : H_(+n)), r)
              : t;
          }),
          (r.y = function(t) {
            return arguments.length
              ? ((n = "function" == typeof t ? t : H_(+t)), r)
              : n;
          }),
          (r.extent = function(t) {
            return arguments.length
      ...
      (t.zoom = function() {
                ...
                .on(
                  ...
                  function() {
                    ...
                    n.zoom(
                      "mouse",
                      o(
                        b(n.that.__zoom, (n.mouse[0] = Ot(n.that)), n.mouse[1]),
                        n.extent,
                        f
                      )
                    );
          ...
          if (r.apply(this, arguments)) {
            ...
            if (n && ((n = clearTimeout(n)), !u.touch1))
              return (
                u.end(),
                void (
                  (a = zt(this).on("dblclick.zoom")) && a.apply(this, arguments)
                )
              );
            e &&
        ...
        function k() {
          var e,
            ...
            c = t.event.changedTouches,
            s = c.length;
          for (Rb(), n && (n = clearTimeout(n)), e = 0; e < s; ++e)
        ...
        return (
          ...
          (M.prototype = {
            ...
            emit: function(t) {
              St(new kb(y, t, this.that.__zoom), d.apply, d, [
                t,
                this.that,
                this.args
              ]);
          ...
          (y.wheelDelta = function(t) {
            return arguments.length
              ? ((a = "function" == typeof t ? t : Sb(+t)), y)
              : a;
          }),
          (y.filter = function(t) {
            return arguments.length
              ? ((r = "function" == typeof t ? t : Sb(!!t)), y)
              : r;
          }),
          (y.touchable = function(t) {
            return arguments.length
              ? ((u = "function" == typeof t ? t : Sb(!!t)), y)
              : u;
          }),
          (y.extent = function(t) {
            return arguments.length
